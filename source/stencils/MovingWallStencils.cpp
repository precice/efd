...
applyLeftWall(FlowField& flowField, int i, int j) {
  flowField.getVelocity().getVector(i, j)[0] =
    _parameters.walls.vectorLeft[0];
  flowField.getVelocity().getVector(i, j)[1] =
    2 * _parameters.walls.vectorLeft[1]
...
applyRightWall(FlowField& flowField, int i, int j) {
  flowField.getVelocity().getVector(i - 1, j)[0] =
    _parameters.walls.vectorRight[0];
  flowField.getVelocity().getVector(i, j)[1] =
...
applyBottomWall(FlowField& flowField, int i, int j) {
  flowField.getVelocity().getVector(i, j)[0] =
    2 * _parameters.walls.vectorBottom[0]
    - flowField.getVelocity().getVector(i, j + 1)[0];
  flowField.getVelocity().getVector(i, j)[1] =
    _parameters.walls.vectorBottom[1];
}
...
applyBottomWall(FlowField& flowField, int i, int j, int k) {
  flowField.getVelocity().getVector(i, j, k)[0] = 2 *
                                                  _parameters.walls.vectorBottom
                                                  [0]
                                                  - flowField.getVelocity().
                                                  getVector(i, j + 1, k)[0];
  flowField.getVelocity().getVector(i, j, k)[1] =
...
applyFrontWall(FlowField& flowField, int i, int j, int k) {
  ...
  flowField.getVelocity().getVector(i, j, k)[1] = 2 *
    ...
    1]
                                                  ...
                                                  getVector(i, j, k + 1)[1];
  flowField.getVelocity().getVector(i, j, k)[2] =
    _parameters.walls.vectorFront[2];
}
...
applyBackWall(FlowField& flowField, int i, int j, int k) {
  flowField.getVelocity().getVector(i, j, k)[0] = 2 *
                                                  _parameters.walls.vectorBack[0
                                                  ]
                                                  - flowField.getVelocity().
                                                  getVector(i, j, k - 1)[0];
  flowField.getVelocity().getVector(i, j, k)[1] = 2 *
                                                  _parameters.walls.vectorBack[1
                                                  ]
                                                  - flowField.getVelocity().
                                                  getVector(i, j, k - 1)[1];
  flowField.getVelocity().getVector(i, j, k - 1)[2] =
...
MovingWallFGHStencil::
applyRightWall(FlowField& flowField, int i, int j, int k) {
  flowField.getFGH().getVector(i - 1, j, k)[0] =
    _parameters.walls.vectorRight[0];
}
...
MovingWallFGHStencil::
applyTopWall(FlowField& flowField, int i, int j, int k) {
  flowField.getFGH().getVector(i, j - 1, k)[1] =
    _parameters.walls.vectorTop[1];
}
