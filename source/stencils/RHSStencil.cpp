...
RHSStencil::
RHSStencil(const Parameters& parameters) : FieldStencil<FlowField>(
                                             parameters) {}
...
apply(FlowField& flowField, int i, int j) {
  flowField.getRHS().getScalar(i, j) = 1.0 / _parameters.timestep.dt *
                                       ((flowField.getFGH().getVector(i, j)[0] -
                                         flowField.getFGH().getVector(i - 1,
                                                                      j)[0])
                                        / _parameters.meshsize->getDx(i, j)
                                        + (flowField.getFGH().getVector(i,
                                                                        j)[1] -
                                           flowField.getFGH().getVector(i, j -
                                                                        1)[1])
                                          ...
                                          ((flowField.getFGH().getVector(i, j,
                                           ...
                                           + (flowField.getFGH().getVector(i, j,
                                              ...
                                              - flowField.getFGH().getVector(i,
                                                                             ...
                                                                             1)[
                                                2])
                                           / _parameters.meshsize->getDz(i, j,
                                                                         k));
}
