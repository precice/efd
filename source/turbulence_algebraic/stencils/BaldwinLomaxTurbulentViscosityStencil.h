/*
 * BaldwinLomaxTurbulentViscosityStencil.h
 *
...
class BaldwinLomaxTurbulentViscosityStencil: public ComputeLocalViscosityStencil {
private:
	FLOAT _kappa;
	FLOAT _delta99;
	FLOAT _A_plus;
...
public:
	...
	virtual ~BaldwinLomaxTurbulentViscosityStencil();
