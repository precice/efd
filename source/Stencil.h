...
public:
   ...
   */
  virtual void
  apply(FlowField& flowField, int i, int j) = 0;
   ...
   */
  virtual void
  apply(FlowField& flowField, int i, int j, int k) = 0;
};
...
public:
   ...
   */
  virtual void
  applyLeftWall(FlowField& flowField, int i, int j) = 0;
   ...
   */
  virtual void
  applyRightWall(FlowField& flowField, int i, int j) = 0;
   ...
   */
  virtual void
  applyBottomWall(FlowField& flowField, int i, int j) = 0;
   ...
   */
  virtual void
  applyTopWall(FlowField& flowField, int i, int j) = 0;
   ...
   */
  virtual void
  applyLeftWall(FlowField& flowField, int i, int j, int k) = 0;
   ...
   */
  virtual void
  applyRightWall(FlowField& flowField, int i, int j, int k) = 0;
   ...
   */
  virtual void
  applyBottomWall(FlowField& flowField, int i, int j, int k) = 0;
   ...
   */
  virtual void
  applyTopWall(FlowField& flowField, int i, int j, int k) = 0;
   ...
   */
  virtual void
  applyFrontWall(FlowField& flowField, int i, int j, int k) = 0;
   ...
   */
  virtual void
  applyBackWall(FlowField& flowField, int i, int j, int k) = 0;
};
