...
protected:
  ...
  const int _size_x; // ! Size of the field in x direction, including
                     // ghost layers
  const int _size_y; // ! Size of the field in y direction, including
                     // ghost layers
  const int _size_z; // ! Size of the field in z direction, including
                     // ghost layers
...
public:
   ...
   */
  int
  index2array(int i, int j, int k = 0) const {
...
public:
   ...
   */
  FLOAT&
  getScalar(int i, int j, int k = 0);

  /** Prints the contents of the field
   *
   * Shows the content of the scalar field by printing them to stdout. Only
   * clear if the
...
public:
   ...
   */
  FLOAT*
  getVector(int i, int j, int k = 0);

  /** Prints the contents of the field
   *
   * Shows the content of the first two components of a vector field by printing
   * them to
